...
<body>
    ...
    <nav class="sidebar">
        ...
        <div>
            <a href="about-me.phpl#about" class="sidebar-text">About Me</a>
        </div>
        <div>
            <a href="coding-examples.php#coding-examples" class="sidebar-text">Coding Examples</a>
        </div>
        <a href="scheme.php#scheme" class="sidebar-present"></i>SCS Scheme</a>
    ...
    <sction id="scheme">
            ...
            <div class="scheme-container">
             ...
             <div class="scheme-item">
                ...
                <p><b> Total Score: xxxxxx</b></p>
                 
     
                 <a href="https://teamtreehouse.com/" class="scheme-button" target="_blank">View website</a>
              ...
              <section class="scheme-item">
                 ...
                 <div class="scheme-logo-container">
                 </div>
              </div>
            </div>
